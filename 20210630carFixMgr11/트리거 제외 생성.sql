...
(
    ...
    car_id     INT             NOT NULL, 
    CONSTRAINT PK_custmer_t PRIMARY KEY (cust_id)
)
/
...
insert into staff_t values(staff_t_SEQ.nextval,'010-2222-2222','대구 동구 신천1동', '19800912','과장','정규직','300만원','전우치');
insert into staff_t values(staff_t_SEQ.nextval,'010-2252-2777','대구 동구 신천2동', '198800512','대리','정규직','250만원','김우치');
insert into staff_t values(staff_t_SEQ.nextval,'010-3332-4232','대구 동구 신천3동', '19780525','대리','정규직','250만원','박우치');
insert into staff_t values(staff_t_SEQ.nextval,'010-1112-2345','대구 동구 신천4동', '19630322','주임','정규직','200만원','이우치');
/*
...
COMMENT ON COLUMN receipt_t.total_price IS '총 결제금액'
/
