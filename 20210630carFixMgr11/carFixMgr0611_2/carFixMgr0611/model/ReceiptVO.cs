...
namespace carFixMgr0611.model
{
    class ReceiptVO
    {
        private string indate; //private 생략가능(디폴트가 private) //접수일
        ...
        public ReceiptVO(string indate, int totalPrice, string custName, string staffName, int receiptId, string carNum) 
            : this(indate, totalPrice, custName, staffName) //여기 this 는 위에 생성자를 쓰는 것.
        {
